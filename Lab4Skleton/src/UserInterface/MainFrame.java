...
/**
 * This project will allow user to create and login customer/supplier accounts.
 * This class displays the main frame with create and login options.
...
public class MainFrame extends javax.swing.JFrame {
    ...
    // go to administration screen which shows created accounts
